...
import com.erp.shop.security.CustomAccessDeniedHandler;
import com.erp.shop.security.CustomUserDetailsService;
import com.erp.shop.security.LoginSuccessHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        // 인가 설정
        http.authorizeRequests((auth)->auth.antMatchers("/admin", "/admin/**").hasRole("ADMIN")
        ...
        // 로그아웃 설정
        http.logout((logout)->logout.invalidateHttpSession(true)        // 세션 무효화
                                    //.deleteCookies("remember-id", "remember-me", "JSESSIONID") // 쿠키 삭제
        ...
        // 자동로그인 설정
        http.rememberMe((remember)->remember.key("erp")
