...
//	List<AuthGA09N204Out00VO> selectList00GA09N204(AuthGA09N204In00VO vo);
    ...
    /* 즐겨찾기등록 */
    List<AuthGA09N207Out00VO> insert00GA09N207(AuthGA09N207In00VO vo);
    /* 즐겨찾기삭제 */
    List<AuthGA09N207Out00VO> delete00GA09N207(AuthGA09N207In00VO vo);
    ...
    /* 알림 읽음 상태 변경 */
    List<AuthGA09N502Out00VO> updateIprtReadYn(AuthGA09N502In00VO vo);
