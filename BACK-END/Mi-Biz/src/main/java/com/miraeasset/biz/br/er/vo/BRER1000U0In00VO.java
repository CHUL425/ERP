...
public class BRER1000U0In00VO {
    public BRER1000U0In00VO() {}
    public BRER1000U0In00VO(String orzCd) {
        this.orzCd = orzCd;
    }
    ...
    @ApiModelProperty(notes = "조직코드", required = true, example = "F04001")
    private String orzCd;            // 조직코드
    @ApiModelProperty(notes = "구분명", example = "1층")
    private String tpNm;
