...
* 	01. 프 로 젝 트 명	: 총무포털
*	02. 업 무 구 분 명	: GA
*	03. 파    일   명	: GA01N301VO.java
*	04. 작  성  일  자	: 2023.06.21
*	05. 작   성   자	: LKM
*	06. 관 련 기 능	: GA01N301	업체관리 원장 항목
*	07. 주  요  사  항	: 키값 조회
*******************************************************************************************************/
...
@Component
public class GA01N301VO extends BaseVO {
    ...
    @ApiModelProperty(notes= "담당자이메일주소암호화값")
    private String chprTlnoEcpVl     ; /*담당자이메일주소암호화값  */
    @ApiModelProperty(notes= "담당자이메일주소암호화값")
    private String chprEmalAdrEcpVl  ; /*담당자이메일주소암호화값*/
...
//    private String oprtDttm          ; /*조작일시                */    
	...
	public String getChprTlnoEcpVl() {
		return chprTlnoEcpVl;
	}

	public void setChprTlnoEcpVl(String chprTlnoEcpVl) {
		this.chprTlnoEcpVl = chprTlnoEcpVl;
	}

	public String getChprEmalAdrEcpVl() {
		return chprEmalAdrEcpVl;
	}

	public void setChprEmalAdrEcpVl(String chprEmalAdrEcpVl) {
		this.chprEmalAdrEcpVl = chprEmalAdrEcpVl;
	}
