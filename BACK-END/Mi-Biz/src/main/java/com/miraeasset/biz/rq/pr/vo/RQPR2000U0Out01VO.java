...
@Component
public class RQPR2000U0Out01VO {
	...
	@ExcelColumnInfo(notes= "거래처")
	@ApiModelProperty(notes= "거래처")
	private String delpNm;
	@ExcelColumnInfo(notes= "물품명")
	...
	@ExcelColumnInfo(notes= "필요요청사항")
	@ApiModelProperty(notes= "필수요청사항")
	private String rqsRqmPtcrCn;
	
	@ExcelColumnInfo(notes= "가격(vat포함)")
	...
	@ExcelColumnInfo(notes= "자격증정보")
	@ApiModelProperty(notes= "자격증정보")
	private String lcnsInfo;
	...
	public String getLcnsInfo() {
		return lcnsInfo;
	}
	public void setLcnsInfo(String lcnsInfo) {
		this.lcnsInfo = lcnsInfo;
	}
