...
@Component
public class RQCR1000U0Out00VO {
	...
	public String toString() {
		return "RQCR1000U0Out00VO [alCnt=" + alCnt + ", rctNo=" + rctNo + ", unifRqsPcd=" + unifRqsPcd + ", unifRqsPcdNm="
				+ unifRqsPcdNm + ", unifRqsDlPcd=" + unifRqsDlPcd + ", unifRqsDlPcdNm=" + unifRqsDlPcdNm + ", unifRqsTcd=" + unifRqsTcd
				+ ", unifRqsTcdNm=" + unifRqsTcdNm + ", rqsTtlNm=" + rqsTtlNm + ", rqsRsnCn=" + rqsRsnCn + ", pbcoLocNm="
				+ pbcoLocNm + ", pbcoDlLocNm=" + pbcoDlLocNm + ", hopeDt=" + hopeDt + ", rqsOrzCd=" + rqsOrzCd
				+ ", rqsOrzNm=" + rqsOrzNm + ", rqsEpno=" + rqsEpno + ", rqsEpNm=" + rqsEpNm + ", rqsEpHndpTlno="
				+ rqsEpHndpTlno + ", rqsDt=" + rqsDt + ", cmpnDt=" + cmpnDt + ", aprvWrrptMtNo=" + aprvWrrptMtNo
				+ ", aprvWrrptOrzCd=" + aprvWrrptOrzCd + ", rqsScd=" + rqsScd + ", rqsScdNm=" + rqsScdNm + "]";
	}
