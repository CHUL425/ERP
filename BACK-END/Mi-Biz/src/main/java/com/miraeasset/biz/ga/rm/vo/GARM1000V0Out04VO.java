...
@Component
public class GARM1000V0Out04VO {
	...
	public String toString() {
		return "GARM1000V0Out04VO [alCnt=" + alCnt + ", orzCd=" + orzCd + ", orzNm=" + orzNm + ", eqmtTcd=" + eqmtTcd
				+ ", eqmtTcdNm=" + eqmtTcdNm + ", rentCntcNo=" + rentCntcNo + ", gdsNm=" + gdsNm + ", istPlcNm="
				+ istPlcNm + ", istPlcDlNm=" + istPlcDlNm + ", optrId=" + optrId + ", oprtChnlCd=" + oprtChnlCd
				+ ", oprtOrzCd=" + oprtOrzCd + ", oprtIpAdr=" + oprtIpAdr + ", oprtDttm=" + oprtDttm + "]";
	}
