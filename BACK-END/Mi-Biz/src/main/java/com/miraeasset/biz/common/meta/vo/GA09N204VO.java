...
* 	01. 프 로 젝 트 명	: 총무포털
*	02. 업 무 구 분 명	: GA
*	03. 파    일   명	: GA09N204VO.java
*	04. 작  성  일  자	: 2023.09.05
*	05. 작   성   자	: LKM
*	06. 관 련 기 능	: GA09N204	화면 원장 항목
*	07. 주  요  사  항	: 키값 조회
*******************************************************************************************************/
...
@Component
public class GA09N204VO extends BaseVO {
	
	@ApiModelProperty(notes= "처리구분: N-신규 U-수정 D-삭제", required = true,example = "N")
