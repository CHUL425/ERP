...
public class RQRR1000U0Out00VO {
	...
	@ExcelColumnInfo(notes= "유형코드명")
    @ApiModelProperty(notes= "유형코드명 신규/이전/AS")
	...
	@ExcelColumnInfo(notes= "신청사원휴대전화번호")
	...
	@ApiModelProperty(notes= "신청사유내용 -> 신청명")
