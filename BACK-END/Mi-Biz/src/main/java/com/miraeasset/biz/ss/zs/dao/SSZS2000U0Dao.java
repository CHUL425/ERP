...
* 	01. 프 로 젝 트 명	: 총무포털
*	02. 업 무 구 분 명	: SS
*	03. 파    일   명	: SSZS2000U0Dao.java
*	04. 작  성  일  자	: 2023.09.05
*	05. 작   성   자	: LKM
*	06. 관 련 기 능	: 포털관리 알림관리 DAO
*	07. 주  요  사  항	: 키값 조회
*******************************************************************************************************/
...
public interface SSZS2000U0Dao {
	
	/* 알림관리 목록조회*/
	List<SSZS2000U0Out00VO> selectListGA09N501(SSZS2000U0In00VO vo);

	/* 알림관리 상세조회 */
	GA09N501VO selectGA09N501(GA09N501VO vo);
	
	
	/* 알림관리 신규등록 */	
    int insertGA09N501(GA09N501VO vo);
    
	/* 알림관리 수정 */	
    int updateGA09N501(GA09N501VO vo);  	

	/* 알림관리 삭제 */	
    int deleteGA09N501(GA09N501VO vo);  	
