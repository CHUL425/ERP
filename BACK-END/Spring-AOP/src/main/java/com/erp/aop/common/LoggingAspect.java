...
public class LoggingAspect {
     ...
     * - 인수
     */
    @Before("execution(* com.erp.aop.service.BoardService*.*(..))")
    ...
    @After("execution(* com.erp.aop.service.BoardService*.*(..))")
     ...
     * - proceed() 			: 대상 메소드 호출
     */
    @Around("execution(* com.erp.aop.service.BoardService*.*(..))")
    ...
    @AfterReturning(pointcut = "execution(* com.erp.aop.service.BoardServiceImpl.*(..))", returning = "result")
    ...
    @AfterThrowing(pointcut = "execution(* com.erp.aop.service.BoardService*.*(..))", throwing ="exception")
